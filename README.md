...
A implementation based on the idea of 'arpsponge' by 
AMS-IX (https://github.com/AMS-IX/arpsponge) but also 
different. It's implemented in C using XDP/BPF with a 
...
on L2 - as in cloud or anything where you don't actually
